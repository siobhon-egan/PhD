...
Molecular "barcodes" are presented for target mitochondrial loci, providing valuable genetic references for species identification. In addition, a [high-throughput sequencing]{.correction} assay is also described using pan-Ixodida primers. 
This provides a high-throughput method to identify ticks by sequencing a ~370 bp product of the 12S rDNA gene on the Illumina MiSeq. 
...
Nucleotide data for multilocus sequence typing (MLST) barcode sequence data produced by Sanger sequencing has been deposited in GenBank under the following accession numbers: OM791407--OM791437 (*COI*), OM756760--OM756765 (*18S rRNA*), OM830716--OM830764 (*12S rDNA*), OM830384--OM830429 (*16S rRNA*).
...
The analysis of mitochondrial loci identified the 12S rDNA gene (~370 bp product) was particularly useful at delimitating species. 
As a result, a [high-throughput sequencing]{.correction} assay was developed for high-throughput species identification. 
...
Ticks [(Acari: Ixodida)]{.correction} parasitise a range of vertebrate hosts and serve as vectors for numerous pathogens that affect both humans and animals. 
...
Following the results from the MLST approach, the ~370 bp product of the 12S rDNA gene was determined as providing optimal results for species delimitation. 
...
The amplicon PCR was carried out using the 12S rDNA gene pan-Ixodida primers, T1B and T2A [@beatiAnalysisSystematicRelationships2001] (\~370 bp product) with Illumina MiSeq adapters (Table \@ref(tab:T2primers)). 
...
**[High-throughput sequencing]{.correction} sequencing**

[High-throughput sequencing]{.correction} sequencing targeting the 12S rDNA gene was successful at identifying tick species. 
...
An ability of the 12S rDNA gene [to act]{.corrected} as a barcoding gene for ticks has been identified in similar studies [@lvAssessmentFourDNA2014;@kandumaMitochondrialNuclearMultilocus2019], and is shown by the level of phylogenetic separation among species shown in Figure \@ref(fig:F2NGStree) (see list of accession numbers and species identification in Table \@ref(tab:T2genbank)).
