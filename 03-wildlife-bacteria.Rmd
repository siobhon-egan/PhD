...
```{r F3preface, out.width='95%', out.align = 'left', echo=FALSE}
knitr::include_graphics("front-and-back-matter/preface/Julimar_fieldwork.png")
```
...
The incidence of tick-borne diseases in many parts of the world are rapidly increasing in both prevalence and geographic distribution [@madison-antenucciEmergingTickBorneDiseases2020]. 
...
Pan-Ixodida primers T1B/T2A [@beatiAnalysisSystematicRelationships2001] were used to amplify an ~370 bp product of the *12S rRNA*
...
Tick *12S rRNA* metabarcoding sequences generated were analysed USEARCH v11 [@edgarSearchClusteringOrders2010] pipeline.
...
Taxonomy was assigned using BLAST analysis and lineage retrieved as outlined above for *16S rRNA* metabarcoding.
...
A nested PCR was used to amplify ~1.4 kb fragment of 16S rRNA gene for *Neoehrlichia* and *Ehrlichia.* 
...
### Bacteria *16S rRNA* metabarcoding
...
In vitro studies of *Ixodes ricinus* and rabbits suggest that the endosymbiont replicates within the vertebrate host [@cafisoMidichloriaMitochondriiEndosymbiont2019]. 
