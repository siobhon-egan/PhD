...
The incidence of tick-borne diseases [in many parts of the word]{.correction} is rapidly increasing in both prevalence and geographic distribution [@madison-antenucciEmergingTickBorneDiseases2020]. 
...
Pan-Ixodida primers T1B/T2A [@beatiAnalysisSystematicRelationships2001] were used to amplify an ~370 bp product of the 12S rDNA gene
...
Tick *12S rDNA* metabarcoding sequences generated were analysed USEARCH v11 [@edgarSearchClusteringOrders2010] pipeline.
...
### [High-throughput sequencing]{.correction}
...
While the cost of [high-throughput sequencing]{.correction} platforms continues to decline, analysis of large numbers of samples is still constrained by resources and funds. 
