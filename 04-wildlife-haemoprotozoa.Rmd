...
Blood samples were screened for piroplasms using a nested PCR targeting an ~ 800 bp product of the 18S rRNA locus  (Table \@ref(tab:T4primers)) [@jefferiesPCRRFLPDetectionDifferentiation2007]. 
...
According to Barbosa [-@barbosaSequenceAnalysesMitochondrial2019] genetic distance thresholds within piroplasms at the 18S rRNA locus can be as little as 0.3% between named species. 
...
The analysis of *Hepatozoon* phylogeny was restricted due to previous studies which amplified different regions of the 18S rRNA locus. 
...
A semi-targeted molecular approach using primers targeting conserved regions of the nuclear 18S rRNA locus provides a number of advantages over using generic eukaryote primers [@bradleyDesignEvaluationIllumina2016;@cannonHighthroughputSequencingAssay2018a].
