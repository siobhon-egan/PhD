...
#####################
title: |
  Ecology of Ticks and Microbes in \
  Australian Wildlife
author: Siobhon Lee Egan
qual: Bachelor of Science (Honours)
university: Murdoch University
university-logo: templates/mulogo.png
#university-footer: templates/mufooter.png
university-logo-width: 5cm
#university-footer-width: 12cm
submitted-text: This thesis is presented for the degree of
degree: Doctor of Philosophy
degreedate: 2022
dedication: For Rhys William John Egan
acknowledgements: |
...
use-biblatex: true
bib-latex-options: "style=authoryear, sorting=nyt, backend=biber, maxcitenames=1, maxbibnames=20, uniquelist=false, firstinits=true, date=year, useprefix, doi=true, isbn=false, url=false, uniquename=false" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
...
output:
  ...
  bookdown::bs4_book: 
    ...
    theme:
      primary: "#6D1919"
    repo: https://github.com/siobhon-egan/PhD
    pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  bookdown::gitbook:
